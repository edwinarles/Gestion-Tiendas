        ...
        <div className="editor-header" style={{ marginBottom: 0 }}>
          <div className="editor-title-row">
            ...
            <div>
              ...
              <span className="upload-text-secondary">UUID: {storeDetails.info?.id}</span>
            </div>
          </div>
          ...
          <div className="editor-actions">
            {role === "propietario" ? (
              ...
              <span style={{ fontSize: "0.85rem", color: "var(--text-secondary)", padding: "0.375rem 0.75rem", border: "1px solid var(--border-color)", borderRadius: "var(--radius-md)" }}>
                Modo Vendedor (Solo Búsqueda/Venta)
              </span>
            )}
          </div>
        </div>
